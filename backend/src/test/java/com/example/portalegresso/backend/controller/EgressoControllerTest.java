...
public class EgressoControllerTest {
    ...
    public void testSalvarEgresso() throws Exception {
        ...
        EgressoDTO dto = new EgressoDTO("Lucas", "lucas@email.com", "Descrição", "foto.png", "linkedin", "insta", "curriculo");
    ...
    public void testSalvarEgressoFalha() throws Exception {
        when(egressoService.salvar(any(Egresso.class))).thenThrow(new RegraNegocioRunTime("E-mail já cadastrado"));
        EgressoDTO dto = new EgressoDTO("Lucas", "lucas@email.com", "Descrição", "foto.png", "linkedin", "insta", "curriculo");
